      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            ...
            <h2 style={{ fontFamily: "Barlow Condensed, sans-serif", fontWeight: 800, fontSize: "clamp(2.2rem, 4vw, 3.2rem)", color: "#1a1a1a", lineHeight: 0.95, marginTop: "0.5rem" }}>
              MÁS DE 10 AÑOS<br />CONSTRUYENDO<br />
              <span style={{ color: "#f5b700" }}>HOGARES DIGNOS.</span>
            </h2>
            <p className="mt-6 text-gray-600" style={{ fontFamily: "Barlow, sans-serif", fontWeight: 300, lineHeight: 1.8, fontSize: "0.95rem" }}>
              Somos un grupo de entidades técnicas con más de 10 años de experiencia en la construcción de viviendas sociales, otorgándole hogares dignos a las familias que más lo necesitan.
            </p>
            <p className="mt-4 text-gray-600" style={{ fontFamily: "Barlow, sans-serif", fontWeight: 300, lineHeight: 1.8, fontSize: "0.95rem" }}>
              Trabajamos de la mano con las familias y con el Estado para hacer realidad el programa de vivienda Techo Propio, entregando construcciones seguras, de calidad y con acompañamiento técnico de principio a fin.
            </p>
